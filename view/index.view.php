    ...
    <div class="row">
        <form class="col-11 col-lg-7 mx-auto" id="form" method="post">
            ...
            <div class="form-group d-flex justify-content-center">
                <input id="addButton" name="addButton" class="btn btn-success font-weight-bold text-white" type="button" value="Add">
            </div>
        </form>
</div>

    <div class="row">
        <table class="table table-sm col-md-10 mb-5 mx-auto text-center">
            <thead>
